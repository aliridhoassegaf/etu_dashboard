...
{{-- ============================================================ --}}
  ...
  <div class="ax-profile" x-data="axDropdown()" @keydown.escape="close()" @click.outside="close()">
    <button type="button" class="ax-profile__trigger" @click="toggle()" aria-haspopup="menu" :aria-expanded="open" aria-controls="ax-profile-menu" aria-label="Account menu">
      <img class="ax-avatar ax-profile__avatar" src="https://i.pravatar.cc/64?img=12" alt="Ali Ridho" width="32" height="32" />
    </button>
    <div id="ax-profile-menu" class="ax-dropdown ax-profile__menu" role="menu" x-show="open" x-transition.opacity.duration.150ms x-cloak>
      <div class="ax-profile__card">
        ...
        <span class="ax-profile__card-meta"><b>Ali Ridho</b><small>aliridho@expressgroup.co.id</small></span>
      </div>
      <a class="ax-dropdown__item" role="menuitem" href="{{ url("admin-profile") }}"><svg class="ax-icon ax-dropdown__lead" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" aria-hidden="true"><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /></svg>My Profile</a>
