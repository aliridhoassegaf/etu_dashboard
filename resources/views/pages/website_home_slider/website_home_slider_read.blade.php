                    ...
                    <form method="GET">
                      ...
                      <div class="ax-modal__body" style="display:flex;flex-direction:column;gap:var(--ax-space-5);">
                        <div class="ax-field">
                          ...
                          <input id="fe-name" type="text" name="search" class="ax-input" placeholder="Search name, URL" value="{{ request('search') }}">
                        </div>
            ...
            <table class="ax-table ax-table--striped ax-table--hover">
              ...
              <thead class="ax-table__head">
                <tr>
                  ...
                  <th class="ax-table__th" scope="col">Image</th>
                  <th class="ax-table__th" scope="col">URL</th>
                ...
                @foreach($result as $value)
                  <tr class="ax-table__row">
                    ...
                    <td class="ax-table__td" style="font-weight:var(--ax-weight-medium);color:var(--ax-text-strong);">
                      <a href="{{ url('website-home-slider/' . $value['id']) }}">{{ $value['name'] }}</a>
                    </td>
                    <td class="ax-table__td" style="font-weight:var(--ax-weight-medium);color:var(--ax-text-strong);">
                      <img src="{{ $value['image'] }}" style="max-width: 100px;">
                    </td>
                    <td class="ax-table__td" style="color:var(--ax-text-muted);">
                      <a href="{{ url('admin/' . $value['id']) }}">{{ $value['url'] ?? '-' }}</a>
                    </td>
                    ...
                    <td class="ax-table__td">
                      <div class="ax-cluster" style="gap:6px;flex-wrap:nowrap;">
                        ...
                        <a class="ax-btn ax-btn--secondary ax-btn--sm ax-btn--icon" href="{{ url('website-home-slider/' . $value['id']) }}" aria-label="Email">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
