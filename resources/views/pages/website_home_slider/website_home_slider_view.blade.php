  ...
  <div class="ax-dash-grid">
    <nav data-ax-breadcrumb aria-label="Breadcrumb">
      <ol class="ax-breadcrumb__list">
        ...
        <li class="ax-breadcrumb__item"><a href="{{ url("website-home") }}">Home</a></li>
        <li class="ax-breadcrumb__sep" aria-hidden="true"><svg class="ax-icon ax-icon--directional" viewBox="0 0 24 24"
            fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"
            aria-hidden="true">
            <path d="M9 6l6 6l-6 6"></path>
          </svg></li>
        <li class="ax-breadcrumb__item"><a href="{{ url("website-home-slider") }}">Home Slider</a></li>
        <li class="ax-breadcrumb__sep" aria-hidden="true"><svg class="ax-icon ax-icon--directional" viewBox="0 0 24 24"
            fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"
            aria-hidden="true">
            <path d="M9 6l6 6l-6 6"></path>
    ...
    <section class="ax-card ax-col--12" role="region" aria-label="Default table">
      ...
      <div class="ax-card__body pt-0!" style="display:flex;flex-direction:column;gap:var(--ax-space-5);">
        ...
        <div class="ax-field">
          <label class="ax-label" for="fe-name">Title</label>
          <input class="ax-input" value="{{ $result['title'] ?? '-' }}" disabled style="color:var(--ax-text-muted);">
        </div>

        <div class="ax-field">
          <label class="ax-label" for="fe-name">Image</label>
          <img src="{{ $result['image'] }}" style="max-width: 100px;">
        </div>
        ...
        <div class="ax-field">
          <label class="ax-label" for="fe-name">URL</label>
          <input class="ax-input" value="{{ $result['url'] ?? '-' }}" disabled style="color:var(--ax-text-muted);">
        </div>

        <div class="ax-field">
          <label class="ax-label" for="fe-name">Sort</label>
          <input class="ax-input" value="{{ $result['sort'] ?? '-' }}" disabled style="color:var(--ax-text-muted);">
        </div>
