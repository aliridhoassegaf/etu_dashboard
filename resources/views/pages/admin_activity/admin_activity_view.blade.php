  ...
  <div class="ax-dash-grid">
    <nav data-ax-breadcrumb aria-label="Breadcrumb">
      <ol class="ax-breadcrumb__list">
        ...
        <li class="ax-breadcrumb__item"><a href="{{ url("admin-activity") }}">Admin Activity</a></li>
        <li class="ax-breadcrumb__sep" aria-hidden="true"><svg class="ax-icon ax-icon--directional" viewBox="0 0 24 24"
            fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"
            aria-hidden="true">
            <path d="M9 6l6 6l-6 6"></path>
          </svg></li>
        <li class="ax-breadcrumb__item" aria-current="page">{{ $result['created_at'] ?? '-' }}</li>
      </ol>
    </nav>
    <!-- ───── DEFAULT TABLE ───── -->
    <section class="ax-card ax-col--12" role="region" aria-label="Default table">
      <div class="ax-card__header">
        <div class="ax-card__titles">
          ...
          <p class="ax-card__subtitle">Viewing detail for <strong>{{ $result['created_at'] ?? '-' }}</strong></p>
        </div>
      </div>
      <div class="ax-card__body pt-0!" style="display:flex;flex-direction:column;gap:var(--ax-space-5);">
        <div class="ax-field">
          <label class="ax-label" for="fe-name">Target Name</label>
          <input class="ax-input" value="{{ $result['target_name'] ?? '-' }}" disabled style="color:var(--ax-text-muted);">
        </div>
        <div class="ax-field">
        ...
        <div class="ax-field">
          <label class="ax-label" for="fe-name">IP Address</label>
          <input class="ax-input" value="{{ $result['ip'] ?? '-' }}" disabled style="color:var(--ax-text-muted);">
        </div>
        <div class="ax-field">
          <label class="ax-label" for="fe-name">Action</label>
          <input class="ax-input" value="{{ $result['action'] ?? '-' }}" disabled style="color:var(--ax-text-muted);">
        </div>
        <div class="ax-field">
