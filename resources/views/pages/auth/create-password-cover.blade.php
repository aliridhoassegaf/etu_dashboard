<!doctype html>
<html lang="en" data-ax-route="auth/create-password-cover">
    ...
    <div class="ax-auth-cover" style="display:grid;grid-template-columns:1fr;width:100%;min-block-size:100vh;">
      ...
      <aside class="ax-auth-cover__panel" aria-hidden="true"
             style="position:relative;overflow:hidden;display:none;flex-direction:column;justify-content:space-between;padding:var(--ax-space-10);background:
               radial-gradient(120% 120% at 18% 12%, rgba(var(--ax-accent-rgb),.32), transparent 55%),
               radial-gradient(140% 120% at 92% 96%, rgba(var(--ax-accent-rgb),.18), transparent 60%),
               linear-gradient(160deg, var(--ax-surface-solid), var(--ax-accent-wash));">
        <span style="position:absolute;inset:0;background:repeating-linear-gradient(135deg, transparent 0 22px, rgba(var(--ax-accent-rgb),.05) 22px 23px);"></span>
        <span style="position:absolute;width:300px;height:300px;border-radius:50%;right:-70px;top:22%;border:1px solid rgba(var(--ax-accent-rgb),.28);"></span>
        ...
        <div style="position:relative;max-width:30ch;">
          <svg viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="color:var(--ax-accent);margin-block-end:var(--ax-space-4);"><path d="M16.555 3.843l3.602 3.602a2.877 2.877 0 0 1 0 4.069l-2.643 2.643a2.877 2.877 0 0 1 -4.069 0l-.301 -.301l-6.558 6.558a2 2 0 0 1 -1.239 .578l-.175 .008h-1.172a1 1 0 0 1 -.993 -.883l-.007 -.117v-1.172a2 2 0 0 1 .467 -1.284l.119 -.13l.414 -.414h2v-2h2v-2l2.144 -2.144l-.301 -.301a2.877 2.877 0 0 1 0 -4.069l2.643 -2.643a2.877 2.877 0 0 1 4.069 0"/><path d="M15 9h.01"/></svg>
          <p style="font-family:var(--ax-font-display);font-size:var(--ax-text-xl);font-weight:600;color:var(--ax-text-strong);line-height:1.3;margin:0;">One strong password, every device covered.</p>
          <p style="font-size:var(--ax-text-sm);color:var(--ax-text-muted);margin-block-start:var(--ax-space-3);">We hash your password and never store it in plain text.</p>
        </div>
      </aside>

      <!-- ── RIGHT: form pane ── -->
      <section class="ax-auth-cover__pane" style="display:grid;place-items:center;padding:var(--ax-space-8) var(--ax-space-6);">
        <div class="ax-card" style="width:100%;max-width:440px;" x-data="createPassword()">
              ...
              <div>
                <div class="ax-alert ax-alert--danger" role="alert" style="margin-block-end:var(--ax-space-5);">
                  ...
                  <div class="ax-alert__content">
                    ...
                    <p class="ax-alert__message">Reset links are valid for 60 minutes. Request a fresh one to continue.</p>
                  </div>
                </div>
                <a class="ax-btn ax-btn--primary ax-btn--block" href="/auth/reset-password-basic" style="min-height:44px;"><span class="ax-btn__label">Request a new link</span></a>
              </div>
            </template>
