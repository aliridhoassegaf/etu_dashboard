<!doctype html>
<html lang="en" data-ax-route="auth/sign-up-basic">
...
<body class="ax-standalone">
  ...
  <main class="ax-center" id="ax-main" style="inline-size:100%;max-inline-size:400px;position:relative;z-index:1;">
    <div style="inline-size:100%;display:flex;flex-direction:column;gap:var(--ax-space-5);">
      ...
      <section class="ax-card" role="region" aria-label="Create your account" x-data="axSignupForm()" style="border-radius:var(--ax-radius-xl);">
        <div class="ax-card__body" style="padding:var(--ax-space-8);display:flex;flex-direction:column;gap:var(--ax-space-5);">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:var(--ax-space-2);">
            <button type="button" class="ax-btn ax-btn--secondary" aria-label="Sign up with Google">
            ...
            <button type="button" class="ax-btn ax-btn--secondary" aria-label="Sign up with Apple">
            ...
            <button type="button" class="ax-btn ax-btn--secondary" aria-label="Sign up with GitHub">
          ...
          <p style="text-align:center;margin:0;font-size:var(--ax-text-sm);color:var(--ax-text-muted);">
            Already have an account? <a class="ax-link" href="/auth/sign-in-basic" style="font-weight:var(--ax-weight-medium);">Sign in</a>
          </p>
        </div>
      </section>
    </div>
    ...
    function axSignupForm() {
      return {
        ...
        barClass(i) {
          ...
          if (this.score <= 1) return 'is-weak';
        ...
        submit() {
          ...
          this.loading = true;
          // Demo only — never hits the network. Simulates an "email already in use" response.
