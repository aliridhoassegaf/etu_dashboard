<!doctype html>
<html lang="en" data-ax-route="auth/sign-in-cover">
  ...
  <div class="ax-auth-cover" style="position:relative;z-index:1;min-block-size:100dvh;display:grid;grid-template-columns:1fr;">
    ...
    <aside class="ax-auth-cover__panel" aria-hidden="true"
      ...
      <div class="ax-cluster" style="gap:var(--ax-space-3);position:relative;">
        <span class="ax-center"
              style="inline-size:40px;block-size:40px;border-radius:var(--ax-radius-md);background:var(--ax-gradient-accent);color:var(--ax-on-accent);box-shadow:0 8px 22px -8px rgba(var(--ax-accent-rgb),.7);">
      ...
      <div style="position:relative;max-inline-size:30ch;">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" width="34" height="34" style="color:var(--ax-accent);opacity:.55;margin-block-end:var(--ax-space-4);"><path d="M10 11h-4a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h3a1 1 0 0 1 1 1v6c0 2.667 -1.333 4.333 -4 5"/><path d="M19 11h-4a1 1 0 0 1 -1 -1v-3a1 1 0 0 1 1 -1h3a1 1 0 0 1 1 1v6c0 2.667 -1.333 4.333 -4 5"/></svg>
        <p style="margin:0;font-family:var(--ax-font-display);font-size:var(--ax-text-xl);line-height:1.4;font-weight:var(--ax-weight-medium);color:var(--ax-text-strong);">Everything our team needs, finally in one calm surface. Vireo just gets out of the way.</p>
        <div class="ax-cluster" style="gap:var(--ax-space-3);margin-block-start:var(--ax-space-5);">
          <span class="ax-avatar ax-avatar--squircle" style="background:color-mix(in oklab, var(--ax-viz-violet) 18%, transparent);color:var(--ax-viz-violet);">
            <svg class="ax-avatar__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0"/><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2"/></svg>
          </span>
          <div><div style="font-weight:var(--ax-weight-semibold);color:var(--ax-text-strong);font-size:var(--ax-text-sm);">Priya Nair</div><div style="font-size:var(--ax-text-xs);color:var(--ax-text-muted);">Head of Operations · Northwind</div></div>
        </div>
      </div>
      ...
      <div class="ax-cluster" style="gap:var(--ax-space-5);position:relative;">
        ...
        <div><div class="ax-num" style="font-family:var(--ax-font-display);font-size:var(--ax-text-xl);font-weight:var(--ax-weight-semibold);color:var(--ax-text-strong);">99.98%</div><div style="font-size:var(--ax-text-xs);color:var(--ax-text-muted);">uptime</div></div>
    ...
    <main class="ax-center" id="ax-main" style="position:relative;padding:var(--ax-space-8) var(--ax-space-6);">
      ...
      <div x-data="axAuthForm()" style="inline-size:100%;max-inline-size:440px;display:flex;flex-direction:column;gap:var(--ax-space-6);">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:var(--ax-space-2);">
          <button type="button" class="ax-btn ax-btn--secondary" aria-label="Continue with Google"><svg class="ax-btn__icon" viewBox="0 0 48 48" aria-hidden="true"><path fill="#FFC107" d="M43.611 20.083H42V20H24v8h11.303c-1.649 4.657-6.08 8-11.303 8-6.627 0-12-5.373-12-12s5.373-12 12-12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4 12.955 4 4 12.955 4 24s8.955 20 20 20 20-8.955 20-20c0-1.341-.138-2.65-.389-3.917z"/><path fill="#FF3D00" d="M6.306 14.691l6.571 4.819C14.655 15.108 18.961 12 24 12c3.059 0 5.842 1.154 7.961 3.039l5.657-5.657C34.046 6.053 29.268 4 24 4 16.318 4 9.656 8.337 6.306 14.691z"/><path fill="#4CAF50" d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238A11.91 11.91 0 0 1 24 36c-5.202 0-9.619-3.317-11.283-7.946l-6.522 5.025C9.505 39.556 16.227 44 24 44z"/><path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303a12.04 12.04 0 0 1-4.087 5.571l.003-.002 6.19 5.238C36.971 39.205 44 34 44 24c0-1.341-.138-2.65-.389-3.917z"/></svg></button>
          <button type="button" class="ax-btn ax-btn--secondary" aria-label="Continue with Apple"><svg class="ax-btn__icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M16.365 1.43c0 1.14-.493 2.27-1.177 3.08-.744.9-1.99 1.57-2.987 1.57-.12 0-.23-.02-.3-.03-.01-.06-.04-.22-.04-.39 0-1.15.572-2.27 1.206-2.98.804-.94 2.142-1.64 3.248-1.68.03.13.05.28.05.43zm4.565 15.71c-.03.07-.463 1.58-1.518 3.12-.945 1.34-1.94 2.71-3.43 2.71-1.517 0-1.9-.88-3.63-.88-1.698 0-2.302.91-3.67.91-1.377 0-2.332-1.26-3.428-2.8-1.287-1.82-2.323-4.63-2.323-7.28 0-4.28 2.797-6.55 5.552-6.55 1.448 0 2.675.95 3.6.95.865 0 2.222-1.01 3.902-1.01.613 0 2.886.06 4.374 2.19-.13.09-2.383 1.37-2.383 4.19 0 3.26 2.854 4.42 2.955 4.45z"/></svg></button>
          <button type="button" class="ax-btn ax-btn--secondary" aria-label="Continue with GitHub"><svg class="ax-btn__icon" viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12z"/></svg></button>
        </div>
        ...
        <form @submit.prevent="submit()" style="display:flex;flex-direction:column;gap:var(--ax-space-4);" novalidate>
          ...
          <div class="ax-field">
            <div class="ax-cluster" style="justify-content:space-between;">
              ...
              <a class="ax-link" href="/auth/reset-password-cover" style="font-size:var(--ax-text-xs);">Forgot password?</a>
            </div>
          ...
          <label class="ax-check" style="font-size:var(--ax-text-sm);color:var(--ax-text);">
            <input type="checkbox" class="ax-checkbox" x-model="remember"><span>Keep me signed in</span>
          </label>
        ...
        <p style="margin:0;font-size:var(--ax-text-sm);color:var(--ax-text-muted);">
          New to Vireo? <a class="ax-link" href="/auth/sign-up-cover" style="font-weight:var(--ax-weight-medium);">Create an account</a>
        </p>
      </div>
    </main>
  </div>
  ...
  <script>
    ...
    function axAuthForm() {
      return {
        ...
        validate() {
          this.emailErr = !this.email.trim() ? 'Enter your email or username.' : (this.email.includes('@') && !/^[^@\s]+@[^@\s]+\.[^@\s]+$/.test(this.email.trim()) ? 'Enter a valid email address.' : '');
