  ...
  <div class="ax-dash-grid">
    <nav data-ax-breadcrumb aria-label="Breadcrumb">
      <ol class="ax-breadcrumb__list">
        ...
        <li class="ax-breadcrumb__item" aria-current="page">Admin Users</li>
      </ol>
    </nav>
    <!-- ───── DEFAULT TABLE ───── -->
    <section class="ax-card ax-col--12" role="region" aria-label="Default table">
                      ...
                      <div class="ax-modal__body" style="display:flex;flex-direction:column;gap:var(--ax-space-5);">
                        ...
                        <div class="ax-field">
                          ...
                          <select id="fe-country" class="ax-select" name="admin_role_id">
                            ...
                            @forelse ($adminRoles as $value_select)
                              <option
                                  value="{{ $value_select['id'] }}"
                                  {{ request('admin_role_id') == $value_select['id'] ? 'selected' : '' }}
                              >
                                  {{ $value_select['name'] }}
                              </option>
                            @empty
      ...
      @endif
      @if(request('search') || request('admin_role_id') || request('status'))
        <div class="ax-card__body pt-0!">
          ...
          <div style="display:flex;flex-wrap:wrap;gap:var(--ax-space-2);min-height:24px;">
              ...
              @if(request('admin_role_id'))
                  @php
                      $selectedRole = collect($adminRoles)
                          ->firstWhere('id', request('admin_role_id'));
                  @endphp
                  ...
                  @if($selectedRole)
                      <span class="ax-badge ax-badge--soft ax-badge--accent ax-badge--chip">
                          ...
                          <button
                              ...
                              onclick="removeFilter('admin_role_id')"
                          >
                              <svg
                                  viewBox="0 0 24 24"
                                  fill="none"
            ...
            <tbody>
              @foreach($result as $value)
                <tr class="ax-table__row">
                  ...
                  <td class="ax-table__td" style="color:var(--ax-text-muted);">{{ $value['admin_role_name'] }}</td>
                  ...
                  <td class="ax-table__td">
                    <div class="ax-cluster" style="gap:6px;flex-wrap:nowrap;">
                      ...
                      <a class="ax-btn ax-btn--secondary ax-btn--sm ax-btn--icon" href="{{ url('admin/' . $value['id']) }}" aria-label="Email">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                          stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="ax-card__body">
          <div class="ax-cluster" style="justify-content:space-between;gap:var(--ax-space-4);">
              ...
              @if (($pagination['last_page'] ?? 1) > 1)
                  ...
                  <nav class="ax-pagination" aria-label="Admin pages">
