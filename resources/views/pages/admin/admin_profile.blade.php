...
@section('content')
        ...
        <div class="ax-page-head">
          <div class="ax-page-head__row">
            <div>
              ...
              <h1 class="ax-page-head__title">My Profile</h1>
        ...
        <div class="ax-dash-grid pt-0!">
          ...
          <nav class="ax-card ax-col--3" role="region" aria-label="Settings sections" style="align-self:start;">
            <div class="ax-card__body" style="padding:var(--ax-space-3);">
              <div role="tablist" aria-orientation="vertical" aria-label="Settings" style="display:flex;flex-direction:column;gap:2px;">
                <a href="#" role="tab" class="ax-btn ax-btn--ghost ax-btn--block"  style="justify-content:flex-start;background: var(--ax-fill-hover);"
                        :aria-selected="tab==='account'" :class="{ 'is-selected': tab==='account' }" @click="tab='account'">
                  <svg class="ax-icon ax-dropdown__lead" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" aria-hidden="true"><path d="M8 7a4 4 0 1 0 8 0a4 4 0 0 0 -8 0" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /></svg>
                ...
                <button type="button" role="tab" class="ax-btn ax-btn--ghost ax-btn--block" style="justify-content:flex-start;"
                  ...
                  <span class="ax-btn__label">Account Settings</span>
                </button>
                <button type="button" role="tab" class="ax-btn ax-btn--ghost ax-btn--block" style="justify-content:flex-start;"
                        :aria-selected="tab==='notifications'" :class="{ 'is-selected': tab==='notifications' }" @click="tab='notifications'">
                  <svg class="ax-icon ax-dropdown__lead" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" aria-hidden="true"><path d="M12 8l0 4l2 2" /><path d="M3.05 11a9 9 0 1 1 .5 4m-.5 5v-5h5" /></svg>
          ...
          <div class="ax-col--9" style="display:flex;flex-direction:column;gap:var(--ax-space-6);">
            ...
            <!-- ░░░ ACCOUNT ░░░ -->
            <div role="tabpanel" aria-label="Account settings"
                 class="ax-stack" style="--ax-gap:var(--ax-space-6);">

              <section class="ax-card" role="region" aria-label="Personal information">
                <div class="ax-card__header"><div class="ax-card__titles"><h2 class="ax-card__title">My Profile</h2></div></div>
                <div class="ax-card__body" style="padding-top:0;display:grid;grid-template-columns:1fr 1fr;gap:var(--ax-space-5);">
                  <div class="ax-field" style="grid-column:1 / -1;"><label class="ax-label" for="fullname">Fullname</label><input id="fullname" name="fullname" type="text" class="ax-input" disabled style="color:var(--ax-text-muted);" value="{{ $result['fullname'] ?? '-' }}"></div>

                  <div class="ax-field" style="grid-column:1 / -1;"><label class="ax-label" for="email">Email</label><input id="email" name="email" type="text" class="ax-input" disabled style="color:var(--ax-text-muted);" value="{{ $result['email'] ?? '-' }}"></div>

                  <div class="ax-field" style="grid-column:1 / -1;"><label class="ax-label" for="phone">Phone</label><input id="phone" name="phone" type="text" class="ax-input" disabled style="color:var(--ax-text-muted);" value="{{ $result['phone'] ?? '-' }}"></div>

                  <div class="ax-field" style="grid-column:1 / -1;"><label class="ax-label" for="email">Role Access</label><input id="admin_role_name" name="admin_role_name" type="text" class="ax-input" disabled style="color:var(--ax-text-muted);" value="{{ $result['admin_role_name'] ?? '-' }}"></div>

                  <div class="ax-field" style="grid-column:1 / -1;"><label class="ax-label" for="status">Status</label><input id="status" name="status" type="text" class="ax-input" disabled style="color:var(--ax-text-muted);" value="{{ $result['status_name'] ?? '-' }}"></div>
